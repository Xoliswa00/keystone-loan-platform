@section('title', 'Terms & Conditions — Keystone Capital Partners')
@section('description', 'Terms and conditions governing credit applications with Keystone Capital Partners.')

<x-marketing-layout>
  <section class="kc-section-light">
    <div class="max-w-3xl mx-auto px-6 py-16">
      <h1 class="kc-display-2 text-kc-navy mb-8">Terms & Conditions</h1>
      ...
      <div class="kc-card">
        <div class="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-kc-charcoal/70">Registered Credit Provider · National Credit Act 34 of 2005</p>
          </div>
        </div>
