<x-app-layout>
  ...
  <div class="kc-card max-w-lg">
    <p class="text-sm text-kc-charcoal/60 mb-4">Repayment schedules are generated automatically and are read-only. Use the Collections workflow to manage overdue accounts.</p>
