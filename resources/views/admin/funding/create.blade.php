  ...
  <form method="POST" action="{{ route('admin.funding.store') }}" enctype="multipart/form-data"
    ...
    <div class="kc-card space-y-4">
      ...
      <div class="grid grid-cols-2 gap-3">
        <div>
          ...
          <div class="relative">
            ...
            <span class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-kc-charcoal/70">decimal</span>
          </div>
          <p class="text-[10px] text-kc-charcoal/70 mt-0.5">e.g. 0.1200 = 12% per annum</p>
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        <div>
          <label class="kc-label">Maturity Date <span class="text-kc-charcoal/70 text-[10px]">(blank = revolving)</span></label>
      ...
      <div>
        <label class="kc-label">Facility Agreement (PDF) <span class="text-kc-charcoal/70 text-[10px]">optional</span></label>
