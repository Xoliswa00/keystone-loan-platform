<x-app-layout>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Payments</p><p class="font-display text-2xl font-bold text-kc-navy mt-1">{{ $totals->count ?? 0 }}</p></div>
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Total Collected</p><p class="font-display text-2xl font-bold text-emerald-600 mt-1">R {{ number_format($totals->total_collected ?? 0, 2) }}</p></div>
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Interest</p><p class="font-display text-2xl font-bold text-kc-navy mt-1">R {{ number_format($totals->total_interest ?? 0, 2) }}</p></div>
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Nu-Pay Fees</p><p class="font-display text-2xl font-bold text-kc-charcoal mt-1">R {{ number_format($totals->total_nupay_fees ?? 0, 2) }}</p></div>
  </div>
