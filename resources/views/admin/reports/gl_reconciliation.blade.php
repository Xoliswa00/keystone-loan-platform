<x-app-layout>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Total Debits</p><p class="font-display text-xl font-bold text-kc-navy mt-1">R {{ number_format($summary->total_debit ?? 0, 2) }}</p></div>
    <div class="kc-stat-card"><p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Total Credits</p><p class="font-display text-xl font-bold text-kc-navy mt-1">R {{ number_format($summary->total_credit ?? 0, 2) }}</p></div>
    <div class="kc-stat-card">
      <p class="text-xs text-kc-charcoal/50 uppercase tracking-wider">Unbalanced Batches</p>
