...
<form method="POST" action="{{ $action }}" class="space-y-5">
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
    ...
    <div>
      ...
      <p class="text-[11px] text-kc-charcoal/40 mt-1">Set to 1–1 for a single-instalment product, or e.g. 2–5 to allow multi-month terms.</p>
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
    <div>
      ...
      <p class="text-[11px] text-kc-charcoal/40 mt-1">As a fraction, e.g. 0.05 = 5%/month. NCA cap: {{ config('nca.interest_rate_cap_monthly') }}.</p>
    </div>
    <div>
    ...
    <div>
      ...
      <p class="text-[11px] text-kc-charcoal/40 mt-1">NCA cap: R{{ config('nca.initiation_fee_flat_cap') }}.</p>
    </div>
    <div>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
    <div>
      ...
      <p class="text-[11px] text-kc-charcoal/40 mt-1">NCA absolute cap: R{{ config('nca.initiation_fee_absolute_cap') }}.</p>
    </div>
    <div>
      ...
      <p class="text-[11px] text-kc-charcoal/40 mt-1">NCA cap: R{{ config('nca.monthly_service_fee_cap') }}.</p>
    </div>
  </div>
