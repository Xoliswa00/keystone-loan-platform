      ...
      <div class="kc-card space-y-4 lg:col-span-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="sm:col-span-2">
            <label class="kc-label">CC on All Loan Notifications <span class="text-kc-charcoal/40 text-[10px]">comma-separated</span></label>
            ...
            <p class="text-[10px] text-kc-charcoal/40 mt-1">All approval, rejection, disbursement and payment notifications will CC these addresses.</p>
          </div>
        </div>
