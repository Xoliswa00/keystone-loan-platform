    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="kc-card space-y-4">
        ...
        <div>
          ...
          <p class="text-[11px] text-kc-charcoal/70 mt-1">A client with this many active (non-settled) loans is blocked from applying for another. Set to 1 for the standard "one loan at a time" rule.</p>
        </div>
        ...
        <div>
          ...
          <p class="text-[11px] text-kc-charcoal/70 mt-1">NCR reckless-lending waiting period after a rejected application before the client may reapply.</p>
        </div>
      </div>
      ...
      <div class="kc-card space-y-4">
        ...
        <div>
          ...
          <p class="text-[11px] text-kc-charcoal/70 mt-1">As a fraction, e.g. 0.30 = 30%. NCA affordability guideline.</p>
        </div>
      </div>
      ...
      <div class="kc-card space-y-4">
        ...
        <p class="text-[11px] text-kc-charcoal/70">Risk score (0–100) at which the CLO advisory engine recommends REVIEW or ESCALATE instead of APPROVE.</p>
      ...
      <div class="kc-card space-y-4">
        ...
        <p class="text-[11px] text-kc-charcoal/70">Rates as fractions, e.g. 0.20 = 20%. Should escalate: Stage 1 &lt; Stage 2 &lt; Stage 3.</p>
      </div>
      ...
      <div class="kc-card space-y-4">
        ...
        <div>
          ...
          <p class="text-[11px] text-kc-charcoal/70 mt-1">DPD at which the intermediate "second notice" escalation tier fires — between the Stage 2 and Stage 3 IFRS 9 boundaries above.</p>
        </div>
      </div>
      ...
      <div class="kc-card space-y-4">
        ...
        <div>
          ...
          <p class="text-[11px] text-kc-charcoal/70 mt-1">Default for the daily reminder cron. A manual run with an explicit <code>--days</code> flag still overrides this.</p>
        </div>
      </div>
    </div>
