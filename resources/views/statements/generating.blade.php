  ...
  <div class="max-w-md mx-auto text-center py-12"
    ...
    <div class="kc-card">
      ...
      <div x-show="ready" class="mb-6">
        ...
        <p class="text-sm text-kc-charcoal/70 mt-2">Your statement for {{ $period_label }} has been generated.</p>
      </div>
      ...
      <div x-show="error" class="mb-6">
        ...
        <p class="text-sm text-kc-charcoal/70 mt-2" x-text="errorMessage"></p>
      </div>
