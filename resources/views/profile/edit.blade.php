<x-app-layout>
  ...
  <div class="max-w-2xl space-y-5">
    ...
    <div class="kc-card">
      ...
      <p class="text-xs text-kc-charcoal/70 mb-4">Min 8 characters — must include at least one letter and one number.</p>
    ...
    <div class="kc-card flex items-center justify-between">
      <div>
        ...
        <p class="text-xs text-kc-charcoal/70 mt-0.5">Income, expenses, bank analysis, documents</p>
      </div>
    ...
    <div class="kc-card flex items-center justify-between">
      <div>
        ...
        <p class="text-xs text-kc-charcoal/70 mt-0.5">Debit order account for repayments</p>
      </div>
    ...
    <div class="kc-card">
      ...
      <p class="text-xs text-kc-charcoal/70 mb-4">
