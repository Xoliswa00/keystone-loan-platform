...
class FinancialPeriod extends Model
{
    protected $fillable = [
        ...
        'bank_recon_complete', 'trial_balance_generated',
    ...
    public function isClosed(): bool   { return in_array($this->status, ['closed', 'locked']); }
    public function isLocked(): bool   { return $this->status === 'locked'; }
    public function canPost(): bool    { return in_array($this->status, ['open', 'closing']); }
