...
{
    /**
     * Maps NuPay Excel headers to database columns.
     * This MUST reflect the canonical NuPay schema.
     */
    ...
    /**
     * Returns the expected Excel headers.
     * Useful for validation & error reporting.
     */
